          ...
          with col2 :
               with st.expander("Analyse de la prescription"):                                  
                    ...
                    for i in range(compteur):                   
                         if i == 0 :
                              if data_frame.loc[{medoc}, 'Category'][i] != data_frame.loc['# Choisir un médicament', 'Category'] :
...
st.write(f"str(option2) == '# Choisir une liste de médicaments' : {option2 == '# Choisir une liste de médicaments'}")
